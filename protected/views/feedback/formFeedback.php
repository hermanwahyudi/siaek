...
<div class="headline"> <h1 class="text-justify">Form Kirim Feedback</h1>  </div>

<div class="row">
<div class="form-group">
			<label for="" class="col-md-3 control-label"><?php echo $form->labelEx($model,'komentar'); ?></label>
				<div class="col-md-5">
					<?php echo $form->textArea($model,'komentar',array('class'=>'form-control')); ?>
					<span class="error-label"><?php echo $form->error($model,'komentar'); ?></span>
				</div>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="form-group">
			<label for="" class="col-sm-3 control-label"><?php echo $form->labelEx($model,'id_regional'); ?></label>
	...
	<div class="row">
<div class="form-group">
			<label for="" class="col-md-3 control-label"><?php echo $form->labelEx($model,'nama_kegiatan'); ?></label>
				<div class="col-md-5">
